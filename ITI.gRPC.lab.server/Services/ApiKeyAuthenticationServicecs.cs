...
{
    public class ApiKeyAuthenticationServicecs : IApiKeyAuthenticationService
    {
        private readonly IHttpContextAccessor httpContextAccessor;
        private readonly IConfiguration configuration;

        public ApiKeyAuthenticationServicecs (IHttpContextAccessor httpContextAccessor, IConfiguration configuration)
        {
